...
private:
    ...
    int configObj(std::string& path, const WIN32_FILE_ATTRIBUTE_DATA& stat, std::string px);
    int configFile(std::string& path, const WIN32_FILE_ATTRIBUTE_DATA& stat, std::string px);
    int configDir(std::string& path, const WIN32_FILE_ATTRIBUTE_DATA& stat, std::string px);
